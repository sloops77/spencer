...
declare interface SchemaBuilders {
    ...
    findMany<U extends Schema, V>(result: U, overrides: V): V & { querystring: { type: "object", properties: { limit: { type: "integer", minimum: 0 }, offset: { type: "integer", minimum: 0 } } }, response: ({ 200: { type: "array", items: U } } & ErrorResponses), tags?: string[] }
