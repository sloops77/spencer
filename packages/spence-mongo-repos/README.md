...
## Operations
### `find({ filter: MongoFilter, sort: MongoSort, limit: integer, skip: integer }, projection: MongoProjection): Promise<object[]>`
...
### `findById(_id: string, projection: MongoProjection): Promise<object>`
Finds a single document by id
- `_id` to find
- `projection` is a regular mongo projection object. Defaults to your default.

### `findOne({filter: MongoFilter, sort: MongoSort}, projection: MongoProjection): Promise<object | undefined>` 
Finds the first document to match the filter and sort specified.
- `filter` is a regular mongo query object
- `sort` is the way to sort things. Use the regular mongo sort object
- `projection` is a regular mongo projection object. Defaults to your default.

### `count({filter: MongoFilter}): Promise<integer>`
Counts the documents matching the filter
- `filter` is a regular mongo query object

### `insert(val: object, projection: MongoProjection): Promise<object>`
...
### `insertMany(vals: object[], projection: MongoProjection): Promise<object[]>`
...
### `findOrInsert(val: object, naturalKey: string, projection: MongoProjection): Promise<object>`
...
### `update(_id*: string, val: MongoSet, projection: MongoProjection): Promise<object>`
Update by id. Updates all the fields for you. Sets `updatedAt`. Dispatches a updated events.
- `_id` to update
- `val` to set
- `projection` is a regular mongo projection object. Defaults to your default.

### `updateUsingFilter({filter: MongoFilter}, val*: MongoSet, projection: MongoProjection): Promise<object[]>`
...
### `upsert(_id: string, val*: object, projection: MongoProjection): Promise<object>`
...
### `touch(_id: string, projection: MongoProjection): Promise<object>`
...
### `delUsingFilter({filter: MongoFilter}): Promise<string[]>`
